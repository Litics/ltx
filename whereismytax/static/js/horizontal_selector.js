...
//	    console.info("running horizontalSelector")

		$(this).each(function(){
//            console.info("running each horizontalSelector")
...
jQuery.fn.extend({
	...
	buildSelector: function (){
		...
		var title = $(this).attr("name").replace(new RegExp('&nbsp;', 'g'), '').trim();
		...
		function construct(){
				...
				var newHtml = "<hr><h3>"+ title +"</h3><hr><hr><table><tr>";
